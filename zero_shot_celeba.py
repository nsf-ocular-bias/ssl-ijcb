...
class CustomDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = f"../datasets/celeba/img_align_celeba/img_align_celeba/{row['image_id']}"
...
def main():
    ...
    ds = CustomDataset(df, preprocess)
    ...
    for attr in attributes:
        ...
        import pickle
        with open(f"../datasets/celeba/{attr}_similarities.pkl", "wb") as f:
